...
from fuji_server.models.test_rule_output import TestRuleOutput  # noqa: F401,E501
...
class TestRule(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'TestRule':
    ...
    @property
    def output(self) -> TestRuleOutput:
    ...
    @output.setter
    def output(self, output: TestRuleOutput):
